...
Story ID: components-scroll-area--playground

```
import { ScrollAreaExample } from "@reina-madre/design-system";

const Playground = () => <ScrollAreaExample />;
```
...
<div className="mb-12"><ScrollAreaOrientations /></div>

## Especificaciones

<div className="mb-12"><ScrollAreaSpecifications /></div>
