...
Story ID: components-progress--playground

```
import { ProgressExample } from "@reina-madre/design-system";

const Playground = () => <div className="w-[433px] max-w-[calc(100vw-32px)]"><ProgressExample /></div>;
```
...
<div className="mb-12"><ProgressValues /></div>

## Composición

<div className="mb-12"><ProgressComposition /></div>

## Especificaciones

<div className="mb-12"><ProgressSpecifications /></div>
