...
<div style={{ marginBottom: 48 }}><SliderTypes /></div>

## Orientación

<div style={{ marginBottom: 48 }}><SliderOrientations /></div>

## Valores y estados

<div style={{ marginBottom: 48 }}><SliderStates /></div>

## Especificaciones

<div style={{ marginBottom: 48 }}><SliderSpecifications /></div>
