...
<summary><strong>v1.0.1</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `popover/foreground`, `muted/foreground`, `primary`, `primary/20%`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
