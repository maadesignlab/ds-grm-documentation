...
<summary><strong>v1.0.2</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `foreground`, `muted/foreground`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
