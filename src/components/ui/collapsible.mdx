...
<div style={{ marginBottom: 48 }}><CollapsiblePatterns /></div>

## Estados

<div style={{ marginBottom: 48 }}><CollapsibleStates /></div>

## Especificaciones

<div style={{ marginBottom: 48 }}><CollapsibleSpecifications /></div>
