...
<summary><strong>v1.0.1</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `foreground`, `border`, `muted/foreground`, `muted`, `primary`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
