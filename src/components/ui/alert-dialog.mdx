...
<summary><strong>v1.0.1</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `background`, `border`, `muted`, `foreground`, `popover/foreground`, `muted/foreground`, `primary`, `destructive/20%`, `destructive/light`, `destructive/light-border`, `destructive/light-foreground`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
