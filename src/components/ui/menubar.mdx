...
<div style={{ marginBottom: 48 }}><MenubarStates /></div>

## Cantidad de opciones

<div style={{ marginBottom: 48 }}><MenubarAmounts /></div>

## Composición

<div style={{ marginBottom: 48 }}><MenubarCompositions /></div>

## Especificaciones

<div style={{ marginBottom: 48 }}><MenubarSpecifications /></div>
