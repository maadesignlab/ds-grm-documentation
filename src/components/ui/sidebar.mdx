...
<summary><strong>v1.4.1</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `background`, `border`, `foreground`, `sidebar/foreground`, `muted/foreground`, `sidebar/border`, `sidebar/accent/foreground`, `sidebar/accent`, `primary`, `sidebar/primary`, `sidebar/ring`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
