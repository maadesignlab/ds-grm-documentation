...
<summary><strong>v1.0.1</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `muted`, `muted/foreground`, `background/10%`, `foreground`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
