...
<summary><strong>v1.0.1</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `foreground`, `muted/foreground`, `input`, `muted`, `border`, `primary`, `primary/default-border`, `background`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
