...
<summary><strong>v1.0.1</strong> · Sincronización Figma para DS v1.1.0</summary>
  ...
  **Tokens consumidos en esta actualización:** `primary/15%`, `success/default-border`, `foreground`, `success`, `muted`, `muted/foreground`, `primary/10%`, `primary/default-foreground`, `accent`, `primary/default-border`. Consulta sus valores anteriores y actuales en Foundations → Tokens.
